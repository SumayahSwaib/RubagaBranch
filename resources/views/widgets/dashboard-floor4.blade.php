...
?><a href="{{ admin_url('rooms') }}"
    ...
    <div class="card-body py-0 pb-2 pb-md-4">
        <p class="h3  text-bold mb-2 mb-md-3 text-white ">Forth Floor</p>
       {{--  <p class="  m-0 text-center text-primary h3" style="line-height: 3.2rem">{{ number_format($rooms->count()) }}</p> --}}
        ...
        <p class="mt-4 mb-2 text-light text-uppercase">
            ...
            Available: <span class=" text-light"
        ...
        <p class="h4  text-bold mb-2 bg-primary text-white pl-3 pt-2 pb-1">  FROM E01 -  E20</p>
